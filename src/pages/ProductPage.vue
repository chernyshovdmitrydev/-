          ...
          <form class="form" action="#" method="POST" @submit.prevent="addToCart">
            ...
            <div class="item__row">
              <div class="form__counter">
                <button type="button" aria-label="Убрать один товар" @click.prevent="deleteProductAmount">
                ...
                <button type="button" aria-label="Добавить один товар" @click.prevent="addProductAmount">
                  <svg width="12" height="12" fill="currentColor">
